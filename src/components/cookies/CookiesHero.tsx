...
export default function CookiesHero() {
  return (
    <section className={styles.pageHeader} aria-labelledby="cookies-page-title">
      <div
      ...
      <div className={styles.container}>
        <div className={styles.pageHeaderInner}>
          <h1 id="cookies-page-title">Cookies Policy</h1>
          <nav className={styles.breadcrumbWrap} aria-label="Breadcrumb">
            <ol className={styles.breadcrumb}>
              ...
              <li aria-current="page">Cookies Policy</li>
            </ol>
          </nav>
        </div>
      </div>
