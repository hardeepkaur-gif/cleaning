...
export const servicesTabsTitle = "Shine Brighter with Our Cleaning Services";

export const servicesList: ServiceData[] = [
  {
    label: "Domestic",
    title: "Domestic Cleaning Services London",
    text: "Available home cleaning in London for house owners, flat renters and hectic professionals. Choose regular cleaning one-off cleaning, weekly cleaning.",
    href: "#contact",
    icon: FaHome,
  ...
  },
  {
    ...
    text: "Carpet cleaning London service not only helps you get rid of stains, lift embedded dirt, but at the same time it helps you protect your carpet investment.",
    href: "#contact",
    icon: FaCouch,
