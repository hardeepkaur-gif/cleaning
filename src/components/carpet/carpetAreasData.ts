...
export const carpetAreasNoteBefore =
  "Whether you need carpet cleaning for a ";

export const carpetAreasNoteLinkLabel = "house, flat, office or rental property";

export const carpetAreasNoteAfter =
  ", our team can provide deep carpet cleaning, stain removal and steam carpet cleaning at a time that suits you.";
