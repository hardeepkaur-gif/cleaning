...
export const carpetFaqs: CarpetFaqItem[] = [
  {
    ...
    a: "Most standard rooms take around 20 to 40 minutes to clean. Larger homes, heavily stained carpets, or commercial properties may require additional time depending on the size and condition of the carpets. Drying time depends on the cleaning method, carpet material, and room ventilation. Hot water extraction carpets usually dry within 3 to 6 hours, while dry carpet cleaning allows carpets to be used much sooner.",
    img: `${faqImgBase}/faq-duration.webp`,
    alt: "Typical carpet cleaning duration and drying time for London homes",
  },
  {
