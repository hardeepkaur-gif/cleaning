...
export const gutterFaqs: GutterFaqItem[] = [
  {
    ...
    alt: "Average gutter cleaning cost guide for London properties",
  },
  {
    ...
    alt: "Blocked gutters causing property damage to fascias and walls",
  },
  {
    ...
    alt: "Downpipe clearing included in professional gutter cleaning",
  },
  {
    ...
    alt: "Gutter cleaning for three storey London homes and buildings",
  },
  {
    ...
    alt: "Gutter cleaning above conservatories using telescopic equipment",
  },
  {
    ...
    alt: "Gutter cleaning completed while homeowner is away from property",
  },
  {
    ...
    alt: "Typical duration of a residential gutter cleaning appointment",
  },
];
