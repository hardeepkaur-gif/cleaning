...
import local from "./AboutApproachSection.module.css";
...
const steps: ProcessStep[] = [
  {
    ...
    title: "Assess",
    text: "We look at the scope of the property and confirm what's included in your booking.",
    accent: "primary",
  },
  {
    icon: PiClipboardTextDuotone,
    title: "Prepare",
    text: "Our team arrives with the right products and equipment for the job.",
    accent: "cta",
  },
  {
    icon: PiSprayBottleDuotone,
    title: "Clean",
    text: "We work through the agreed scope carefully and methodically.",
    accent: "primary",
  },
  {
    icon: PiSealCheckDuotone,
    title: "Inspect",
    text: "Where possible, we encourage you to check the completed work.",
    accent: "cta",
  },
  {
    icon: PiChatCircleDuotone,
    title: "Resolve",
    text: "If something isn't right, tell us promptly. We'll look into it.",
    accent: "primary",
  },
  {
    icon: PiHandshakeDuotone,
    title: "Confirm",
    text: "Once you're happy, we close the job and keep a clear record of what was completed.",
    accent: "cta",
  },
];
    ...
    >
      <div className={styles.cardIconWrap} ref={iconRef}>
        ...
        <span
          ...
          role="img"
          aria-label={`${step.title} step icon`}
        >
          <Icon aria-hidden />
        </span>
      </div>
    ...
    >
      <div className={styles.container}>
        <div className={`${styles.topHeader} ${local.topHeader}`}>
          <h2 className={styles.title} id="about-approach-title">
            Our Approach to Cleaning
          </h2>
          <p className={local.intro}>
            We keep our process straightforward so you always know what to
            expect:
          </p>
        </div>
